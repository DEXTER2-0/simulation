...
class Graphique : 
    def __init__ (self,canvas, simulation):
        ...
        self.objet = self.canvas.create_oval(self.simulation.pos_x - self.robot.rayonDuRobotCm , self.simulation.pos_y - self.robot.rayonDuRobotCm,self.simulation.pos_x + self.robot.rayonDuRobotCm, self.simulation.pos_y + self.rayonDuRobotCm, width=self.robot.l, fill="red")
    ...
    def update(self):
        ...
        self.canvas.coords(self.objet,self.simulation.pos_x - self.rayonDuRobotCm , self.simulation.pos_y - self.rayonDuRobotCm,self.simulation.pos_x + self.rayonDuRobotCm, self.simulation.pos_y + self.robot.rayonDuRobotCm)
